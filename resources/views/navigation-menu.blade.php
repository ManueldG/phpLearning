...
<nav x-data="{ open: false }" class="bg-orange-300 dark:bg-gray-800 border-b dark:border-gray-100 border-gray-700">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                @auth
                    ...
                    <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                        <x-nav-link href="{{ route('page.show', 1) }}" :active="request()->routeIs('page.show',1)">
                            {{ __('Tutorial Php') }}
                        </x-nav-link>
                    </div>
                        ...
                        <x-dropdown align="right" width="60">
                            <x-slot name="trigger">
                                <span class="inline-flex rounded-md">
                                    <button type="button" class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-gray-500 dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none focus:bg-gray-50 dark:focus:bg-gray-700 active:bg-gray-50 dark:active:bg-gray-700 transition ease-in-out duration-150">
                    ...
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            ...
                            @if(Auth::user()->id==1)
                                ...
                                <x-dropdown-link href="{{ route('page.show',1) }}">
                                    {{ __('Lessons') }}
                                </x-dropdown-link>
                            @endif
            ...
            <div class="-me-2 flex items-center sm:hidden ">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-gray-400 dark:text-gray-500 hover:text-gray-500 dark:hover:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-900 focus:outline-none focus:bg-gray-100 dark:focus:bg-gray-900 focus:text-gray-500 dark:focus:text-gray-400 transition duration-150 ease-in-out">
                    <svg class="size-6 text-black dark:text-white" stroke="currentColor" fill="none" viewBox="0 0 24 24">
