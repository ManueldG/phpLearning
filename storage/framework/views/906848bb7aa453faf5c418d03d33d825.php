...
<?php endif; ?>
    ...
    <div class="flex flex-row ">
       ...
       <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" class="ms-1 size-5 fill-indigo-500">
        ...
        <div>
            Su questo portale è possibile utilizzare la console <a class="text-gray-500 dark:text-gray-400" href="<?php echo e(route('console')); ?>">PHPSandBox</a> per fare pratica con il codice PHP nei vari capitoli leggere la spiegazione e provare il codice proposto inoltre nell'area personale c'è la possibilità di richiedere il token per usare le <a class="text-gray-500 dark:text-gray-400" href="<?php echo e(route('api-tokens.index')); ?>">API esposte</a>.
        </div>
...
<?php /**PATH C:\Users\Manuel\OneDrive\Pictures\Documents\Sviluppo\multidb\api\resources\views/components/home.blade.php ENDPATH**/ ?>