...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['team', 'component' => 'dropdown-link']));
...
foreach (array_filter((['team', 'component' => 'dropdown-link']), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
...
<?php $component->withAttributes(['href' => '#','x-on:click.prevent' => '$root.submit();']); ?>
        <div class="flex items-center">
            <!--[if BLOCK]><![endif]--><?php if(Auth::user()->isCurrentTeam($team)): ?>
...
<?php /**PATH C:\Users\Manuel\OneDrive\Pictures\Documents\Sviluppo\multidb\api\resources\views/components/switchable-team.blade.php ENDPATH**/ ?>