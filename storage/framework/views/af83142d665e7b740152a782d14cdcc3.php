...
<?php endif; ?>
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                <!-- Teams Dropdown -->
                <?php if(Laravel\Jetstream\Jetstream::hasTeamFeatures() && env('ENABLE_TEAM')): ?>
                    <?php if(auth()->guard()->check()): ?>
...
<?php if(0): ?> {!-- // XXX credo si possa togliere da verificare  --}
...
<?php endif; ?>
<?php /**PATH C:\Users\Manuel\OneDrive\Pictures\Documents\Sviluppo\multidb\api\resources\views\navigation-menu.blade.php ENDPATH**/ ?>